...
In Vignette 1 (“Getting Started”) we illustrated the principles of constrained proportional assignment using protein profiles that represent mass spectrometry data from a set of subcellular fractions in the form of normalized specific amounts (sum of all fractions constrained to 1).  This vignette describes how to use functions in the `protlocassign` package to transform such profiles in a manner that is more useful for inferring proportional residence in subcellular compartments.
