...
```{r, echo=TRUE, eval=TRUE, fig.show='hold'}
markerLocRrsa <- rsaDirect(SS=markerLocRuse, nDiffFractions=6,
...
protProfileLevelsRSA <- rsaDirect(SS=protProfileLevelsUse,
...
```{r, echo=TRUE, eval=TRUE}
markerLocRrsa <- rsaDirect(SS=markerLocR, nDiffFractions=6, nNycFractions=3,
        totProt=totProtUse)
...
mixCytoLysoRSA <- RSAtransform(Acup=mixCytoLyso, nDiffFractions=6, nNycFractions=3, totProt=totProtUse)
...
markerLocRrsa <- rsaDirect(SS=markerLocR, nDiffFractions=6, nNycFractions=3, totProt=totProtUse)
