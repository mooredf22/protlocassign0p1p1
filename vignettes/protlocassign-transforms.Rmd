...
To convert to relative specific values, we call "rsaDirect":

```{r, echo=TRUE, eval=TRUE}


finalListRSAuseT <- rsaDirect(protProfileLevels=finalListUse[,3:11],
                                   nDiffFractions=6, nNycFractions=3, totProt=totProtUse)
...
markerLocRrsa <- rsaDirect(protProfileLevels=markerLocR, nDiffFractions=6, nNycFractions=3, totProt=totProtUse)
