...
All seven mixtures have zero error, as we expect. 
...
setwd("c:\\temp5")
fitType="relAmt"
transF=F    # no log2 transformation
#windows(width=8,height=10)
pdf(file=paste("CPA assignProts Jadot", fitType, transF, ".pdf"), width=7, height=11)
mixturePlotPanel(Acup=AcupMarkers, totProt=totProtUse, fitType="relAmt", log2Transf=transF)
dev.off()


windows(width=7,height=10)
mixturePlotPanel(Acup=AcupMarkers) 
`
