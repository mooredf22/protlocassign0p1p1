...
We will first illustrate plotting using a simulation of proteins distributed between the cytoplasm and the lysosome.  We will then extend this to examining simulated proteins distributed cytoplasm and each of the other compartments, which provides insights into the different transformations.  Finally, we provide a function that performs simulations on proteins residing between all pairs of compartments.
