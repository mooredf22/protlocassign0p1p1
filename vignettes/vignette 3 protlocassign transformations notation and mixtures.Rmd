...
$r_{\alpha,l}=\frac{\breve{a}}{{\breve{t}}_l}=\frac{s_{\alpha,l}\bullet\sum_{j}^{k}t_i}{\sum_{j}^{k}{s_\alpha}t_i} =\frac{\tilde{s}_{\alpha,l}\bullet\sum_{j}^{k}t_i}{\sum_{j}^{k}{\tilde{s}_\alpha}t_i}$
