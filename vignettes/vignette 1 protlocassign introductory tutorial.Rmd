...
markerLocRuse <- cpaSetup(protProfileSummary=profilesProtAT5tmtMS2, refLocProteins=refLocProteinsJadot, n.channels=9)
```
...
assignPropsUse <- proLocAll(protProfileSummary=profilesProtAT5tmtMS2,
...
for (i in 1:n.prots) {
   protPlotfun(protName=rownames(assignPropsUse)[i],
       protProfileSummary=profilesProtAT5tmtMS2, n.fractions=9, n.compartments=8,
       Nspectra=T, markerLocR=markerLocRuse, assignPropsMat=assignPropsUse)
}
dev.off()
```   
