...
AcupMarkers <- relAmtTransform(markerLocR, NstartMaterialFractions=6, totProt=totProtAT5)
```
...
markerLocRrsa <- RSAfromS(SS=markerLocR, NstartMaterialFractions=6,
        totProt=totProtAT5)
mixProt1Prot4PropRSA <- proLocAll(protProfileSummary=mixProt1Prot4RSA, 
...
mixProt1Prot4PropRSALog2 <- proLocAll(protProfileSummary=log2(mixProt1Prot4RSA + eps), 
...
mixProt1Prot6PropSpecAmt <- 
                    proLocAll(protProfileSummary=mixProt1Prot6SpecAmt,
