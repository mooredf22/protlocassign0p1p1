...
Now we plot the results for gene number AADAC:

```{r, echo=TRUE, eval=TRUE, fig.width=7, fig.height=7}
protPlotfun(protName="AADAC",
 geneProfileSummary=geneProfileSummaryTMTms2, finalList=finalListUse, n.fractions=9,
...
```
Finally, provide a gene name. Here, we first look for genes in our dataset that start with "AADA". We choose the gene "AADAC", and find the 10 nearest genes.
```{r, echo=TRUE, eval=TRUE}
protIndex("AAD")
